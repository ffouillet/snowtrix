...
use UserBundle\Form\Handler\ChangePasswordFormHandler;
use UserBundle\Form\Handler\EditProfileFormHandler;
use UserBundle\Form\Handler\ForgottenPasswordFormHandler;
use UserBundle\Form\Handler\RegisterFormHandler;
use UserBundle\Form\Handler\ResetPasswordFormHandler;
use UserBundle\Form\LoginType;
use UserBundle\Form\UserProfileEditType;
use UserBundle\Form\UserType;
use UserBundle\Form\UserEditType;
use UserBundle\Form\ForgottenPasswordType;
...
class SecurityController extends Controller
{
    ...
    public function resetPasswordAction(Request $request, $forgottenPasswordKey, $userId, ResetPasswordFormHandler $resetPasswordFormHandler)
    {
        ...
        $user = $this->em->getRepository('UserBundle:User')->findOneBy($findOneUserCriterias);
