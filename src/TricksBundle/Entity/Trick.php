...
class Trick
{
    ...
    /**
     * @ORM\OneToMany(
     *     targetEntity="TricksBundle\Entity\TrickPhoto",
     *     mappedBy="trick",
     *     cascade={"remove"},
     *     orphanRemoval=true)
     * @Assert\Valid()
    ...
    /**
     * @ORM\OneToMany(targetEntity="TricksBundle\Entity\TrickVideo",
     *     mappedBy="trick",
    ...
    /**
     * @ORM\ManyToMany(targetEntity="TricksBundle\Entity\TrickGroup", inversedBy="tricks")
     * @ORM\JoinColumn(nullable=false)
     */
    private $groups;

    /**
     * @ORM\OneToMany(targetEntity="TricksBundle\Entity\TrickComment",
     *     mappedBy="trick",
     *     cascade={"remove"},
     *     orphanRemoval=true)
     */
     ...
     * Add group
     *
     * @param \TricksBundle\Entity\TrickGroup $group
     *
     * @return Trick
     */
    public function addGroup(\TricksBundle\Entity\TrickGroup $group)
    {
        $this->groups[] = $group;
     ...
     * @param \TricksBundle\Entity\TrickGroup $group
     */
    public function removeGroup(\TricksBundle\Entity\TrickGroup $group)
    {
